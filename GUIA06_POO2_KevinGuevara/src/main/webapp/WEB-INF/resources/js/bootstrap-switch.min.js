    ...
    $.fn['bootstrapSwitch'] = function(method) {
        ...
        var methods = {init: function() {
                return this.each(function() {
                    var $element = $(this), $div, $switchLeft, $switchRight, $label, $form = $element.closest('form'), myClasses = "", classes = $element.attr('class'), color, moving, onLabel = "SI", offLabel = "NO", icon = false, textLabel = false;
